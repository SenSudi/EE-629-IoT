...
Dropify.prototype.onFileReady = function(event, src)
{
    ...
    if (this.errorsEvent.errors.length === 0) {
        ...
        // if($('#proj-form')){
        //     var form = $('#proj-form');
        //     var readonly_input = '<input type="file" id="'+this.file.name+'" name="'+this.file.name+'" readonly>'
        //     form.append(readonly_input);
        //     input_id = '#' + this.file.name;
        //     new_input = $(input_id);
        //     new_input.File = this.file;
