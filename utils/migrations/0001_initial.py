    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('command', models.ManyToManyField(blank=True, to='utils.Command')),
            ],
        ),
        migrations.CreateModel(
            name='Data_Dns',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cidr', models.ManyToManyField(blank=True, to='utils.Data_Cidr')),
                ('dns', models.ManyToManyField(blank=True, to='utils.Data_Dns')),
                ('domain', models.ManyToManyField(blank=True, to='utils.Data_Domain')),
                ('email', models.ManyToManyField(blank=True, to='utils.Data_Email')),
                ('file', models.ManyToManyField(blank=True, to='utils.Data_File')),
                ('host', models.ManyToManyField(blank=True, to='utils.Data_Host')),
                ('location', models.ManyToManyField(blank=True, to='utils.Data_Location')),
                ('person', models.ManyToManyField(blank=True, to='utils.Data_Person')),
                ('phone', models.ManyToManyField(blank=True, to='utils.Data_Phone')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project.Project')),
                ('service', models.ManyToManyField(blank=True, to='utils.Data_Service')),
                ('url', models.ManyToManyField(blank=True, to='utils.Data_URL')),
                ('user', models.ManyToManyField(blank=True, to='utils.Data_User')),
                ('vuln', models.ManyToManyField(blank=True, to='utils.Data_Vuln')),
                ('whois', models.ManyToManyField(blank=True, to='utils.Data_Whois')),
            ],
            options={
                'ordering': ('project',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.ManyToManyField(blank=True, to='files.Associated_File')),
                ('phase', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='methodologies.Phase')),
                ('project_type', models.ManyToManyField(blank=True, to='methodologies.Project_Type')),
            ],
            options={
                'ordering': ('sequence',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aggregate', models.IntegerField(blank=True, default=0, null=True)),
            ],
            options={
                'ordering': ('start_time',),
            },
